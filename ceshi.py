...
from train.Learn_Koopman_with_KlinearEig import Klinear_loss, Eig_loss, Network
...
data = data_collecter(env_name="CartPole-dm")
Ktest_data = data.collect_koopman_data(traj_num=10, steps=300, mode="eval")
mse_loss = nn.MSELoss()
...
print(f"Kloss is {Kloss}")
print(f"Eloss is {Eloss}")
